...
const packages = [
    // ── Channels ──
    {
        ...
        icon: '💬',
        repoUrl: 'https://github.com/strategialabsorg/channel-webchat',
    ...
    },
    {
        ...
        icon: '📱',
        repoUrl: 'https://github.com/strategialabsorg/channel-whatsapp',
        category: 'comunicacion',
        isCore: true,
    },
    {
        ...
        icon: '✈️',
        repoUrl: 'https://github.com/strategialabsorg/channel-telegram',
        category: 'comunicacion',
        isCore: false,
    },
    {
        ...
        icon: '📧',
        repoUrl: 'https://github.com/strategialabsorg/channel-email',
        category: 'comunicacion',
        isCore: false,
    },
    // ── Connectors ──
    {
        ...
        icon: '📅',
        repoUrl: 'https://github.com/strategialabsorg/connector-google-calendar',
    ...
    },
    {
        ...
        icon: '🔗',
        repoUrl: 'https://github.com/strategialabsorg/connector-hubspot',
        category: 'integraciones',
        isCore: false,
    },
    {
        ...
        icon: '💳',
        repoUrl: 'https://github.com/strategialabsorg/connector-stripe',
        category: 'integraciones',
        isCore: false,
    },
    // ── Modules ──
    {
        ...
        icon: '🧵',
        repoUrl: 'https://github.com/strategialabsorg/module-lamadrid',
        category: 'ventas',
        isCore: false,
    },
    {
        ...
        icon: '🏠',
        repoUrl: 'https://github.com/strategialabsorg/module-crm-inmobiliaria',
        category: 'ventas',
        isCore: false,
    },
    // ── Plugins ──
    {
        ...
        icon: '🔊',
        repoUrl: 'https://github.com/strategialabsorg/plugin-echo-agent',
        category: 'utilidades',
        isCore: false,
    },
    // ── Skills ──
    {
        ...
        icon: '🎯',
        repoUrl: 'https://github.com/strategialabsorg/skill-lead-qualification',
        category: 'ventas',
        isCore: false,
    },
    {
        ...
        icon: '📋',
        repoUrl: 'https://github.com/strategialabsorg/skill-appointment-booking',
